...
import { runCanonicalCliExecution } from "./run-canonical-cli-execution"

describe("runCanonicalCliExecution", () => {
  it("runs canonical CLI execution through hardened excel route", () => {
    const workbook = {
      Sheet1: [
        ["Visit", "Procedure", "Fee"],
        ["Screening", "CBC", "125"],
