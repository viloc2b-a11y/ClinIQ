...
import { runCanonicalClinIQRunner } from "./run-canonical-cliniq-runner"

describe("STEP 101 — runCanonicalClinIQRunner", () => {
  it("runs canonical ClinIQ runner through hardened Excel path", () => {
    const workbook = {
      Sheet1: [
        ["Visit", "Procedure", "Fee"],
        ["Screening", "CBC", "125"],
    ...
    const result = runCanonicalClinIQRunner({
