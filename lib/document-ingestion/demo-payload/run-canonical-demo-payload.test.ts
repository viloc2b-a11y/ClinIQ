...
import { runCanonicalDemoPayload } from "./run-canonical-demo-payload"

describe("runCanonicalDemoPayload", () => {
  it("runs canonical demo payload pipeline", () => {
    const workbook = {
      Sheet1: [
        ["Visit", "Procedure", "Fee"],
        ["Screening", "CBC", "125"],
    ...
    expect(result.data.payload.meta.schemaVersion).toBe("1.0")
  })
})
